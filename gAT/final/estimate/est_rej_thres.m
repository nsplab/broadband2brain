function [] = est_rej_thres(data_set, elecs, id, cond, T, L, K, delta_t, numiter, t_resolution, tolerance);
% Estimates reject threshold for FRI_int_diode and saves it
...
[t, c, t1] = run_FRI_int_diode(data_set, elecs, training_start, training_start + duration, cond, 0, T, L, K, delta_t, numiter, t_resolution);
